...
<body>
    <div class="sidebar">
        ...
        <ul>
            ...
            <li class="sub-item" style="margin-left: 30px;"><a href="article_Edit.php" class="active"><i class="fas fa-edit"></i> Edit Article</a></li>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="editarticle.php?id=<?php echo $row['id']; ?>" class="btn btn-info" style="color:white; background-color:blue">Edit</a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
